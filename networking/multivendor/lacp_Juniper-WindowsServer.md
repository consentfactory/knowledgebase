...
Basically, set up a NIC team in LACP mode, set your load balancing mode and click ok. Basically. Super basically (you may want to find the best load balance mode).
